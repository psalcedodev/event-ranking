...
try {
	...
	echo '	<button type="submit" class="btn btn-default" name="event1">' . lang('eventrankings_ds_1') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	echo '	<button type="submit" class="btn btn-default" name="event2">' . lang('eventrankings_ds_2') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	echo '	<button type="submit" class="btn btn-default" name="event3">' . lang('eventrankings_ds_3') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	echo '	<button type="submit" class="btn btn-default" name="event4">' . lang('eventrankings_ds_4') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	echo '	<button type="submit" class="btn btn-default" name="event5">' . lang('eventrankings_ds_5') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	echo '	<button type="submit" class="btn btn-default" name="event6">' . lang('eventrankings_ds_6') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	echo '	<button type="submit" class="btn btn-default" name="event7">' . lang('eventrankings_ds_7') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	...
	foreach ($rankingData as $i => $row) {
		...
		if ($eventLevelSelected && number_format($row['eventlevel']) == $eventLevelSelected) {
			...
			echo '<td>Devil Square ' . number_format($row['eventlevel']) . '</td>';
			echo '</tr>';
