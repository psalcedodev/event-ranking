...
try {
	...
	echo '	<button type="submit" class="btn btn-default" name="event1">' . lang('eventrankings_cc_1') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	echo '	<button type="submit" class="btn btn-default" name="event2">' . lang('eventrankings_cc_2') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	echo '	<button type="submit" class="btn btn-default" name="event3">' . lang('eventrankings_cc_3') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	echo '	<button type="submit" class="btn btn-default" name="event4">' . lang('eventrankings_cc_4') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	echo '	<button type="submit" class="btn btn-default" name="event5">' . lang('eventrankings_cc_5') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	echo '	<button type="submit" class="btn btn-default" name="event6">' . lang('eventrankings_cc_6') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	echo '	<button type="submit" class="btn btn-default" name="event7">' . lang('eventrankings_cc_7') . '</button>';
	echo '</div>';
	echo '<div class="btn-group" role="group">';
	...
	foreach ($rankingData as $i => $row) {
		...
		if ($eventLevelSelected && number_format($row['eventlevel']) == $eventLevelSelected) {
			...
			echo '<td>Chaos Castle ' . number_format($row['eventlevel']) . '</td>';
			echo '</tr>';
